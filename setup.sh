...
ln -sf "$directory/dotfiles/ghostty" "$directory/.config/ghostty"
ln -sf "$directory~/dotfiles/karabiner/MyComplex.json" "directory~/.config/karabiner/assets/complex_modifications/MyComplex.json"
