...
keymap.set('n', "<Leader>al", "<CMD>ReplaceFinderCR<CR>", { desc = "Replace CR for Mac" })
keymap.set('x', "<Leader>al", ":ReplaceFinderCR<CR>", { desc = "Replace CR for Mac" })
keymap.set("n", "<Leader>an", "<CMD>NormalizeCaps<CR>", { desc = "Normalize caps", })
keymap.set("x", "<Leader>an", ":NormalizeCaps<CR>", { desc = "Normalize caps", })
keymap.set("n", "<leader>at", "<CMD>FormatDateP<CR>", { desc = "Convert YYYYMMDD → YYYY-MM-DD in selection" })
keymap.set("x", "<leader>at", ":FormatDateP<CR>", { desc = "Convert YYYYMMDD → YYYY-MM-DD in selection" })
...
keymap.set('n', '<Leader>pv', '<CMD>vsplit<CR>', {desc = "Split Window Vertical"})
--- 画面移動
